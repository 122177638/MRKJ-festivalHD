 ...
 * @param {分享所需链接地址} href
 */
export const wxInit = (sharobj, shareEnd) => {
  const wx = Vue.wechat
  wx.config({
    debug: false,
    appId: sharobj.appid,
    timestamp: sharobj.timestamp,
    nonceStr: sharobj.noncestr,
    signature: sharobj.signature,
  ...
  wx.error(function (res) {
    // alert('分享功能错误' + JSON.stringify(res))
